...
class DiscordBot extends Client {
    ...
    login_timestamp = 0;
    statusMessages = [
        { name: 'DEV MODE', type: 1 },
        { name: 'Login Available!', type: 1 },
        { name: 'Shop is comming!', type: 1 }
    ];
    ...
    connect = async () => {
        ...
        try {
            await mongoose.connect(process.env.CONNECTION_STRING, {dbName: 'EMCDB',socketTimeoutMS: 30000});
